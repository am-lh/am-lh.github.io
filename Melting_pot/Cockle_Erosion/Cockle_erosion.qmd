---
title: "A cockle-induced bioturbation model and its impact on sediment erodibility: a meta-analysis to build a generic model taking into account the diversity of fauna activity and sediment habitats."
description: "Lehuen Amélie^a^*, Orvain Francis^a^"
author:
  - name: Amélie Lehuen
date: last-modified
